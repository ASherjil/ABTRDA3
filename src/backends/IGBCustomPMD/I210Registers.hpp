...
constexpr std::uint32_t RDLEN0 =
    0xC008;   // Rx Descriptor Ring Length in bytes (R/W) — must be 128-byte aligned
...
constexpr std::uint32_t TDLEN0 =
    0xE008;   // Tx Descriptor Ring Length in bytes (R/W) — must be 128-byte aligned
